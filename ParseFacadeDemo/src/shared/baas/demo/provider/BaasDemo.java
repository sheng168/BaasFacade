 ...
 */
public final class BaasDemo {
    public static final String AUTHORITY = BaasDemoProvider.class.getName();
    
    /**
     * The scheme part for this provider's URI
     */
    private static final String SCHEME = "content://";
    public static final Uri CONTENT_URI_BASE = Uri.parse(SCHEME + AUTHORITY);
    ...
    public static final class Notes implements BaseColumns {
        ...
        public static final Uri TODO_URI =  Uri.parse(SCHEME + AUTHORITY + "/Todo");
